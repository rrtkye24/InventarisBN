...
<a href="/tambahuser" class="btn btn-primary "><i class="fas fa-plus"></i>Tambah User</a><br><br>
<div class="card">
...
@csrf
  ...
  <div class="mb-3">
    ...
    <select id="role" name='role' required value='{{$edit->role}}' class="form-select" required>
  ...
  <div class="mb-3">
    ...
    <select id="level" name='level'  required value='{{$edit->level}}' class="form-select" required>
